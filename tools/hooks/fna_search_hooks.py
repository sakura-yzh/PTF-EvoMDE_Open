...
from tools.apis.code2net import encode_arch
...
class ModelInfoHook(Hook):
    ...
    def comp_det_madds(self, runner, show_arch_params=True):
        # alphas = runner.model.module.backbone.display_arch_params(show_arch_params=show_arch_params)  # 返回权重列表
        # alphas = [0, 0, 5, 4, 0, 3, 5, 1, 3, 5, 0, 4, 1, 6, 3, 3, 4, 1, 2, 1, 5, 1, 6, 3, 2]
        alphas = encode_arch(runner.model.module.backbone.alpha_index)  # 当前网络编码
